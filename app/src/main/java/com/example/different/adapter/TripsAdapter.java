package com.example.different.adapter;
...
import com.example.different.R;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if(viewType == 0){
           return new TripViewHolder(
                   LayoutInflater.from(parent.getContext()).inflate(R.layout.item_container_trip,
                           parent,false));
           ...
           return  new AdsViewHolder(
                   LayoutInflater.from(parent.getContext()).inflate(
                           R.layout.item_conteainer_ads,parent,false
                   ));
    ...
    static class TripViewHolder extends RecyclerView.ViewHolder {
        ...
        static class AdsViewHolder extends RecyclerView.ViewHolder {
            ...
            public AdsViewHolder(@NonNull View itemView) {
                ...
                textAdsTitle = itemView.findViewById(R.id.textAds);
        ...
        public NewsViewHolder(@NonNull View itemView) {
                super(itemView);
                textNewsTitle = itemView.findViewById(R.id.textNews);
